...
import { brandsSelector, categoriesSelector, createProductAsync, fetchProductsById, ProductByIdSelector, updateProductByIdAsync } from '../../Product-List/ProductSlice'
...
const ProductForm = () => {
  ...
  const handleForm = (data) =>{
    ...
    if(id && selectedProduct){ // here reuse the form if want to edit then dispatch edit else create 
  ...
  return (
    <div>
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className='flex  gap-4 col-span-full'>
              ...
              <div className="mt-2">
                <div className="flex items-center rounded-md bg-white pl-3 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600">
                  <input
                    id="price"
                    {...register('price',{required:'price is required',min:{value:100,message: 'Price must be at least 100'},max:{value:10000,message: 'Price cannot exceed 10000'}})}
                    type="number"
            ...
            <div className="col-span-full">
              ...
              <div className="flex items-center rounded-md bg-white pl-3 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600">
                  <input
                    id="thumbnail"
                    {...register('thumbnail',{required:'thumnail is required'})}
                    type="text"
                    placeholder="Product thumbnail"
                    className="block min-w-0 grow py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6"
                  />
                </div>
                {errors.thumbnail && <span className='text-xs text-red-500' >{errors?.thumbnail.message}</span>}
            </div>
            ...
            <div className="col-span-full">
              ...
              <div className="flex items-center rounded-md bg-white pl-3 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600">
                ...
                {errors.image1 && <span className='text-xs text-red-500' >{errors?.image1.message}</span>}
            </div>
      ...
      <div className="mt-6 flex items-center justify-end gap-x-6">
        <button onClick={()=>handleDelete()} type="button" className="text-sm/6 font-semibold text-gray-900">
          Delete
        </button>
        <button
          type="submit"
