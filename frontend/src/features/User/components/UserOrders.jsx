                                                        ...
                                                        <div>
                                                            <div className="flex justify-between text-base font-medium text-gray-900">
                                                                <div className='flex flex-col '>
                                                                    <a className='text-gray-900' href={item?.href}>{item?.product.title}</a>
                                                                    <span className='text-gray-500'>{item?.product.brand}</span>
                                                                    {item?.color?.[0] && <span className='text-gray-500'>{item?.color?.[0].name}</span>}
                                                                    {item?.size?.[0] && <span className='text-gray-500'>{item?.size?.[0].name}</span>}
                                                                </div>
